    ...
    (function () {
      ...
      function eventsUrl(city) {
        return (
          ...
          '?select=id,title,start_time,end_time,url,location,description,source,transcript,cluster_id,source_urls,category,image_url,all_day,merged_ids,duplicate_group,city' +
