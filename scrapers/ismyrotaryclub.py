...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Scrape Rotary club events from ismyrotaryclub.com"
    )
    ...
    parser.add_argument(
        "--name", required=True, help='Source name (e.g. "Bloomington Rotary Club")'
    )
    parser.add_argument("--output", "-o", type=str, help="Output filename")
    parser.add_argument(
        "--default-url", type=str, help="Fallback URL for events without per-event URLs"
    )
