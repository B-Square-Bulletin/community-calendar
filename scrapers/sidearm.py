...
class SidearmScraper(BaseScraper):
    ...
    def __init__(
        self, base_url: str, source_name: str, tz: str = "America/New_York", home_only: bool = False
    ):
    ...
    def _parse_api_event(self, e: dict, day_date: str) -> dict[str, Any] | None:
    ...
    def _parse_api_datetime(self, day_date: str, time_str: str) -> datetime | None:
        ...
        if time_str:
            ...
            if time_str in ("noon", "12 p.m.") or time_str in ("tba", "tbd", ""):
    ...
    def _parse_jsonld_event(self, data: dict) -> dict[str, Any] | None:
