...
def main():
    ...
    parser.add_argument("--name", default="MaxPreps School", help="School name for custom URL")
    parser.add_argument(
        "--timezone",
    ...
    parser.add_argument("--list-schools", action="store_true", help="List all known schools")
