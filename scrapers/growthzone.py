...
def main():
    ...
    parser.add_argument("--site", choices=list(KNOWN_SITES.keys()), help="Known site to scrape")
    parser.add_argument("--url", help="Custom API URL (overrides --site)")
    parser.add_argument("--name", default="GrowthZone Events", help="Calendar name for custom URL")
    parser.add_argument("--timezone", default="America/Los_Angeles", help="Timezone for events")
