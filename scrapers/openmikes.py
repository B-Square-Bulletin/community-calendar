...
class OpenMikesScraper(BaseScraper):
    ...
    def __init__(self, city_slug: str, source_name: str | None = None, tz: str | None = None):
        super().__init__()
...
def main():
    ...
    parser.add_argument("--city-slug", required=True, help='Slug as in URL, e.g. "Washington-DC"')
