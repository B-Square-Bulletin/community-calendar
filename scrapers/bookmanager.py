...
def main():
    ...
    parser.add_argument(
        "--san", required=True, help='Bookmanager SAN (var san="..." in /events HTML)'
    )
    parser.add_argument(
        "--domain", required=True, help="Store website host (e.g. bakkaphoenixbooks.com)"
    )
    parser.add_argument("--name", required=True, help="Display name for source attribution")
    parser.add_argument(
        "--timezone", default="America/Toronto", help="IANA timezone (default America/Toronto)"
    )
