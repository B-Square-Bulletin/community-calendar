...
- `tests/test_wfiu_community_calendar.py` - WFIU Community Calendar HTML scraper (Horizon date-filtered paging, occurrence cards, run-history degradation guard, aggregator registration contract)
