...
class TestSlugify:
    ...
    def test_meetup(self):
        result = slugify("https://www.meetup.com/bloomington-hikers/events/ical/")
    ...
    def test_libcal(self):
        result = slugify("https://iu.libcal.com/ical?cid=12345")
        assert result == "libcal_iu_12345"

    def test_campuslabs(self):
        result = slugify("https://iu.campuslabs.com/engage/events/ical")
        assert result == "campuslabs_iu"

    def test_livewhale(self):
        result = slugify("https://events.iu.edu/live/ical/events/group_id/56")
...
class TestParseFeedsTxt:
    ...
    def test_scraper_no_name_in_cmd(self):
        content = "# cmd: python scrapers/simple.py\ncities/mycity/simple.ics\n"
        feeds_file = _write_temp(content)
        feeds = parse_feeds_txt(feeds_file)
